...
namespace NewsWebsite.Controllers
{
    public class TeamMembersController : Controller
    {
        ...
        public TeamMembersController(NewsDbContext context, Microsoft.AspNetCore.Hosting.IHostingEnvironment host)
        {
            _context = context;
            _host = host;
        }
        ...
        public async Task<IActionResult> Create(TeamMember teamMember)
        {
            if (ModelState.IsValid)
            {
                ...
                if (teamMember.file != null)
                {
                    ...
                    teamMember.file.CopyTo(new FileStream(fullpath, FileMode.Create));
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Job,Image")] TeamMember teamMember)
        {
            if (id != teamMember.Id)
            {
                return NotFound();
